...
public class MemberUserRegistrationHandler implements UserRegistrationHandler<MemberUser, MemberUserRegistration> {
    ...
    @Transactional(rollbackOn = { MemberNotFoundException.class, ConflictException.class,
            UsernameConflictException.class, UnprocessableException.class })
    @Override
    public MemberUser register(MemberUserRegistration registration) {
        ...
        // For cloud capstone use case only
