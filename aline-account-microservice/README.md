...
3. Under the microservice/target folder there is a .jar file that can be run in order to start your microservice. For the account microservice the command would be `java -jar ./account-microservice/target/account-microservice-0.1.0.jar`
___
