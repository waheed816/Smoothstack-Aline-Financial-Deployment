...
3. Under the microservice/target folder there is a .jar file that can be run in order to start your microservice. For the transaction microservice the command would be `java -jar ./transaction-microservice/target/transaction-microservice-0.1.0.jar`
